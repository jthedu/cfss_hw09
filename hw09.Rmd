...
However, I've included a local copy of the dataset I was working with ([the ".data/mail_210310.6pm.csv" CSV](".data/mail_210310.6pm.csv")) and if you clone my repo, you shouldn't need to run the script. You'll be able to replicate my results using this .Rmd alone. (And if you do run the scraping R script, you'll get different results since the website has updated since I collect my data.)
