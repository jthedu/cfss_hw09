...
drawn heavily from: https://www.tidytextmining.com/ngrams.html#visualizing-bigrams-in-other-texts
...
# PROBLEM - CAN'T GET STOPWORD_SOURCE TO RECOGNIZE BOTH custom & regular stopwords
  ...
  step_ngram(combined_text, num_tokens = 3, min_num_tokens = 1) %>%
...
mail_lda4 <- LDA(mail_dtm, k = 4, control = list(seed = 123))
