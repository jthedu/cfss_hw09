...
custom_title_stop <- bind_rows(tibble(word = common_words, lexicon = c("custom")), stop_words)
...
bing_titles %>%
  ...
  labs(title = "Analysis of Daily Mail titles",
